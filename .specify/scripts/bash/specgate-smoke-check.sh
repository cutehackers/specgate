...
required_files=(
    ...
    ".claude/commands/specgate/code.md"
    ".claude/commands/specgate/test-spec.md"
    ".claude/commands/specgate/test-write.md"
    ...
    ".opencode/command/code.md"
    ".opencode/command/test-spec.md"
    ".opencode/command/test-write.md"
    ...
    ".codex/commands/specgate/code.md"
    ".codex/commands/specgate/test-spec.md"
    ".codex/commands/specgate/test-write.md"
...
if rg -n "/specgate/(feature-set|specify|clarify|code|test-spec|test-write|feature-done)\\b" \
